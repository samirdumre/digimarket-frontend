                        ...
                        {thumbnailUrl && (
                            <div className="border border-gray-300 rounded-lg px-3 py-1 shadow-sm">
                                <div className="flex justify-between items-center">
                                    ...
                                    <button
                                        className="cursor-pointer"
                                        onClick={resetThumbnailUploader}
                                    >
                                        <X
                                            size={20}
                    ...
                    >
                        {({open, isLoading}) => (
                            <button
                                ...
                                disabled={
                                    isLoading || areImagesUploading || imageUrls.length >= 4
                                }
                                className="cursor-pointer"
                            >
                                <div
                                    ...
                                    <p className="text-gray-400 text-xs mt-1">
                                        PNG, JPG, GIF up to 10MB <br/> You can upload upto 4
                                        images{" "}
                                    </p>
                                </div>
                            </button>
                                ...
                                <div className="relative">
                                    <div className="flex gap-x-4">
                                        {imageUrls.map((url, index) => (
                                            <div
                                                className="border border-gray-300 shadow-sm rounded-lg px-3 py-1"
                                                key={index}
                                            >
                                                <div className="flex justify-between items-center">
